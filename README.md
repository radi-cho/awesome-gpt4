...
- [shellGPT](https://github.com/Ach113/shellGPT) - Easy-to-install terminal interface for chatGPT. Supports features such as conversation logging, file input/output.
